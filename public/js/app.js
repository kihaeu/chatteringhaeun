...
var App = React.createClass({
	...
	render: function render() {
		...
		if (this.state.page === 'login') {
			...
			content = React.createElement(SignUpPage, null);
		} else if (this.state.page === 'chat') {
			content = React.createElement(ChatApp, null);
		}
...
},{"./ChatApp.jsx":1,"./LoginPage.jsx":2,"./SignUpPage.jsx":3,"react":160}],5:[function(require,module,exports){
