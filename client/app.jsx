	...
	getInitialState() {
	 ...
	 render() {
		...
		if (this.state.page === 'login') {
		   ...
		   content = <SignUpPage onSignUpSuccess={this.handleSignUpSuccess} onLogin={() => this.setState({ page: 'login' })} />;
		...
		return (
		   <div className="app-container">
			  {this.state.page !== 'login' && this.state.page !== 'signup' && <Sidebar currentPage={this.state.page} onNavigate={this.handleNavigate} />}
