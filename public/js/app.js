...
var App = React.createClass({
	...
	handleJoinRoom: function handleJoinRoom(roomId) {
		this.setState({ page: 'chat', roomId: roomId });
	},
	...
	render: function render() {
		...
		if (this.state.page === 'login') {
			...
			content = React.createElement(ChatSearch, { onJoinRoom: this.handleJoinRoom });
		}
